  ...
  poems: [
    {
      ...
      appreciation: '这首诗是送别诗中的千古名篇，语言朴素而情感真挚。首句以"渭城朝雨浥轻尘"开篇，清晨细雨润湿了渭城的轻尘，一个"浥"字，写出了雨的轻柔，也暗示了诗人心情的沉重。次句"客舍青青柳色新"，旅馆旁的柳树在雨后显得格外青翠，"柳"与"留"谐音，含蓄地表达了诗人的挽留之意。第三句"劝君更尽一杯酒"，一个"更"字，说明已经喝了许多杯，仍不忍分别，再劝一杯，情深意切。末句"西出阳关无故人"，点出送别的原因——友人此去西域，阳关以西荒无人烟，再也见不到老朋友了。全诗以景衬情，将离别之情表达得淋漓尽致，格调虽然低沉，却不失温暖。',
      trivia: '此诗后被谱成乐曲《阳关三叠》，因反复吟唱"西出阳关无故人"一句，故名。演唱时将末句反复叠唱三次，情感层层递进，是唐代最著名的送别曲之一，流传至今。元二是王维的友人，"元"是姓，"二"是排行，唐人习惯以姓加排行称呼朋友。安西指安西都护府，治所在今新疆库车，是唐代管辖西域的最高军政机构。',
      blanks: [1, 5, 10, 15, 20],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"海内存知己，天涯若比邻"是千古名句。诗人以豁达的胸怀，打破了离别的愁苦，认为真正的友情不受地域阻隔。全诗格调高昂，一扫送别诗的悲凉之气，展现了初唐诗歌的蓬勃朝气。前四句写离别的事实和共同的身份，中间四句是诗人的劝慰之词，最后两句是对友人的嘱托——不要沉溺于儿女情长，要像男子汉一样坚强。',
      trivia: '王勃写此诗时年仅十四岁，才华横溢。他是"初唐四杰"之首（另三杰为杨炯、卢照邻、骆宾王），可惜英年早逝，二十七岁便溺水而亡。杜少府是王勃的友人，此诗成为了他们友谊的见证。"初唐四杰"开创了唐诗的新风尚，为唐诗的繁荣奠定了基础。',
      blanks: [2, 7, 12, 17, 22],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写送别后的思念之情，以简洁的笔墨表达了深沉的情感。送别之后，独自掩上柴门，望着眼前的春草，不禁想到：明年春草又绿，你会回来吗？全诗以景寓情，含蓄蕴藉，将对友人的思念和期盼融入自然景物之中。诗人没有直接表达离别的伤感，而是通过春草的循环和对友人归期的疑问，将思念之情表达得含蓄而深沉。',
      trivia: '王维晚年笃信佛教，在蓝田辋川隐居，过着半官半隐的生活。他的山水田园诗被苏轼评价为"诗中有画，画中有诗"。辋川别墅是王维的私人庄园，他在此创作了大量山水诗，形成了独特的"辋川诗派"。',
      blanks: [1, 4, 8, 12],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗描写在灞陵送别友人的情景。灞水浩浩流淌，古树无花，春草令人伤心。诗人借王粲南登的典故，渲染古道的历史沧桑感。落日余晖中，骊歌声声，令人断肠。全诗情景交融，气势雄浑，将离别的伤感与历史的沧桑融为一体。诗人以古道、古树、古人的典故，暗示了离别的永恒主题。',
      trivia: '灞桥折柳送别是唐代著名习俗，"年年柳色，灞陵伤别"成为送别文化的经典意象。唐代诗人送别多至此处，留下了大量送别诗篇。灞陵是汉文帝的陵墓所在地，历史悠久，文化底蕴深厚。',
      blanks: [2, 6, 10, 15, 20],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '这首小诗以杨柳起兴，写出了送别的频繁与伤感。东风吹拂下，御河两岸的杨柳青青，但近来折柳送别太多，柳枝都快被折光了。诗人以柳树的"苦"来映衬离别的频繁，含蓄而有力。全诗虽然只有四句，却用拟人手法赋予柳树生命，表达了对送别频繁的感慨。',
      trivia: '王之涣以《登鹳雀楼》和《凉州词》最为著名，但他的送别诗同样情感真挚。折柳送别是唐代最流行的送别习俗，"柳"与"留"谐音，寓托了挽留之意。这首诗虽然简短，但意蕴深长，是唐代送别诗中的佳作。',
      blanks: [1, 4, 8, 12],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写白居易在长乐坡送别友人时的感慨。昔日被贬时局促不安，如今从容辞官，心境大不相同。诗人将旧友都送走了，只剩下自己的一颗心难以割舍。全诗情感复杂，既有洒脱，又有不舍。前两句写送别的地点和经历，中间四句写心境的变化，最后两句写对友人的不舍。',
      trivia: '白居易一生多次被贬，对离别有深刻体会。他的诗语言平易近人，相传他写完诗后会念给老妪听，若听不懂便修改，直到老妪能懂为止。这种创作态度使他的诗歌具有很强的可读性和感染力。',
      blanks: [2, 6, 11, 16, 21],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写刘禹锡离开华州时与张侍御的告别。诗人以"莫辞酒"反复劝饮，感叹此次分别难以再聚。借女工织帛、军人旗帜的意象，表达对国家局势的忧虑。全诗慷慨激昂，不同于一般送别诗的儿女情长，而是充满了对国家、对友人的关切。',
      trivia: '刘禹锡因参与永贞革新，被贬二十三年，辗转多地。他以"沉舟侧畔千帆过，病树前头万木春"表达乐观精神，被称为"诗豪"。这首诗体现了刘禹锡的豪迈性格和对国家的关切。',
      blanks: [2, 6, 10, 15],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"忽如一夜春风来，千树万树梨花开"是千古名句，以梨花比喻雪花，新奇瑰丽。全诗描绘了西域边塞壮阔的雪景，在此背景下送别友人，情感更加深沉。结尾"雪上空留马行处"，以空旷的雪地上留下的马蹄印，表达了对友人的深深不舍。诗人用夸张的比喻和生动的意象，将边塞的苍凉与离别的伤感融为一体。',
      trivia: '岑参两度出塞，在西域生活多年，对边塞生活有深刻体验。他的边塞诗气势磅礴，与高适并称"高岑"，是唐代边塞诗的代表人物。这首诗被誉为唐代送别诗中最具想象力的作品。',
      blanks: [3, 8, 13, 18, 23],
    },
    {
      id: 'luntai-ge',
      ...
      appreciation: '此诗以雄浑的笔墨描写出师西征的壮观场面。从轮台城头的号角声，到大军出征的浩荡气势，再到战场的艰苦与将士的英勇，层层递进。结尾以"今见功名胜古人"表达对封大夫的赞颂和期许，格调高昂。全诗充满了对将士的赞美和对战争胜利的期待。',
      trivia: '封常清是唐代名将，曾任安西节度使，镇守西域多年。岑参在其幕府任职，与封常清关系密切，写下多首赞颂其功绩的诗篇。这首诗是岑参边塞诗中最具气势的作品之一。',
      blanks: [2, 7, 12, 17, 22],
    },
    {
      id: 'zouma-chuan',
      ...
      appreciation: '此诗以奇特的想象和夸张的手法，描写了边塞出征的壮观场面。诗人用"君不见"开篇，仿佛在对读者讲述一个宏大的故事。走马川边的雪海、平沙莽莽的景象，衬托出出征的艰苦。中间部分写将士们的英勇无畏，马毛带雪、汗气蒸腾、砚水冻凝，都是对极端环境下将士坚韧品质的描写。结尾以敌人的胆怯和我军的胜利在望作结，充满了对胜利的期待。',
      trivia: '这首诗是岑参边塞诗中最具气势和想象力的作品。诗人运用了大量的夸张和拟人手法，将边塞的苍凉与将士的英勇融为一体。"风头如刀面如割"等句子已成为描写边塞风景的经典表达。',
      blanks: [3, 8, 13, 18, 23],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '这首短诗写送别的场景。五月的火山地区人迹罕至，友人骑马远去，快如飞鸟。都护的行营在太白星西边，号角声一响，边塞的天就亮了。全诗以简洁的笔墨，勾勒出边塞送别的壮阔画面。虽然只有四句，却用极少的文字表达了丰富的内容。',
      trivia: '火焰山（火山）是古代丝绸之路上的著名地标，《西游记》中唐僧取经路过此地，孙悟空借芭蕉扇扑灭火焰山的故事家喻户晓。这首诗虽然篇幅短小，但气势磅礴，是岑参边塞诗的代表作。',
      blanks: [1, 4, 8, 12],
    },
    {
      id: 'song-li-fushi',
      ...
      appreciation: '此诗豪迈奔放，充满阳刚之气。六月的火山更加炎热，道路上行人绝迹，但诗人相信友人早已习惯了边塞的艰苦。"功名只向马上取，真是英雄一丈夫"是千古名句，表达了边塞将士建功立业的豪情壮志。全诗充满了对友人的赞美和对战争胜利的期待。',
      trivia: '岑参的边塞诗以豪迈奔放著称，与高适的沉郁顿挫形成鲜明对比。他的诗中充满了对边塞风光的热爱和对将士英勇的赞颂。这首诗是他送别诗中最具气势的作品之一。',
      blanks: [2, 6, 11, 16],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写在交河送别友人返回京城的情景。九月的交河，大雪纷飞，诗人在雪中题诗送别，泪水沾湿了衣衫。全诗简洁而情感浓烈，以雪中题诗、泪满衣的细节，将离别之情表达得淋漓尽致。诗人用极少的文字表达了深沉的感情。',
      trivia: '交河故城是世界上保存最完好的土建筑城市遗址之一，已有两千多年历史，现为全国重点文物保护单位和世界文化遗产。这首诗虽然篇幅短小，但意蕴深长，是岑参送别诗中的佳作。',
      blanks: [1, 4, 8, 12],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写重阳节在蓟州送别友人。秋风萧瑟，故人稀少，今日暂且同饮菊花酒，明天便要像断蓬一样随风飘散。全诗以重阳节的习俗为背景，将节日的欢聚与离别的伤感融为一体，情感真挚。诗人用对比的手法，突出了离别的无奈。',
      trivia: '重阳节登高、饮菊花酒、插茱萸是唐代重要习俗。王维的"遥知兄弟登高处，遍插茱萸少一人"是描写重阳节思乡的千古名句。这首诗虽然篇幅短小，但情感深沉，是唐代送别诗中的佳作。',
      blanks: [1, 4, 8, 12],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"山随平野尽，江入大荒流"是千古名句，描绘了长江出三峡后进入平原的壮阔景象。结尾"仍怜故乡水，万里送行舟"，以拟人手法写故乡的水万里相送，表达了对故乡的深深眷恋。全诗以景寓情，将离别的伤感与对故乡的思念融为一体。',
      trivia: '李白年轻时从四川出发，顺长江东下，这首诗是他初次离开故乡时所作。"仍怜故乡水"中的故乡水指的是四川的江水，李白将其拟人化，写它万里相送，情感真挚动人。这首诗是李白送别诗中最具想象力的作品。',
      blanks: [1, 5, 9, 13, 17],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"烟花三月下扬州"是千古名句，将春天的美景与扬州的繁华融为一体。最后两句以目送孤帆远去，只见长江滚滚东流，将依依不舍的离情表达得含蓄而深沉。全诗虽然只有四句，却用极少的文字表达了丰富的内容和深沉的情感。',
      trivia: '孟浩然是李白最敬重的诗人之一，李白曾写诗赞颂他"吾爱孟夫子，风流天下闻"。这首诗写于开元盛世，当时扬州是全国最繁华的城市之一。黄鹤楼是古代著名的楼台，与岳阳楼、滕王阁并称江南三大名楼。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写送别友人南下江南的情景。荆州与吴地都是水乡，友人乘船而去，春江烟波浩渺。日暮时分，不知征帆停泊何处，天涯一望，令人肝肠寸断。全诗以水为背景，情景交融，将离别之情表达得深沉而含蓄。诗人用"水为乡"的意象，暗示了江南水乡的特点。',
      trivia: '孟浩然是唐代著名山水田园诗人，与王维并称"王孟"。他一生未仕，漫游各地，对江南水乡有深厚感情。"杜十四"是友人杜某，排行第十四，唐人习惯以排行称呼友人。这首诗是孟浩然送别诗中最具情感深度的作品。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"青山一道同云雨，明月何曾是两乡"是千古名句。诗人以豁达的胸怀，打破了地域的隔阂，认为青山共享云雨，明月照耀两地，并非真正的两乡。全诗一扫离别的悲愁，充满了乐观豁达的情怀。诗人用自然意象来表达对友谊的理解，将离别之情转化为对友谊永恒性的赞美。',
      trivia: '王昌龄因"不护细行"被贬龙标，在此任职多年。李白得知后写下《闻王昌龄左迁龙标遥有此寄》，以"我寄愁心与明月，随风直到夜郎西"表达对友人的思念。这首诗体现了王昌龄乐观豁达的人生态度。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写在洞庭湖畔送别友人的情景。秋日的洞庭湖上，孤峰（君山）浮现在水面上，如同仙境。诗人感叹神仙（友人）难以相见，心随湖水悠悠荡漾，表达了深深的不舍之情。全诗以景寓情，将离别的伤感与对洞庭湖的描写融为一体。',
      trivia: '张说是唐代著名政治家和文学家，曾三次担任宰相，被称为"燕许大手笔"。洞庭湖中的君山岛传说是舜帝二妃娥皇、女英的墓地，充满神话色彩。这首诗虽然篇幅短小，但意蕴深长。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写刘长卿在江州再次与友人分别时的感慨。人生际遇难以预料，只能以醉歌度日。江上明月，胡雁南飞，楚山连绵，景色苍茫。诗人感叹年老体衰，却仍愿将余勇付诸东流，表达了不甘沉沦的精神。全诗情感复杂，既有对人生的感慨，又有对友谊的珍视。',
      trivia: '刘长卿一生多次被贬，仕途坎坷。他的诗以五言为主，语言清丽，情感深沉，被誉为"五言长城"。这首诗是他晚年的作品，反映了他对人生的深刻思考。',
      blanks: [2, 6, 11, 16],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"浮云游子意，落日故人情"是千古名句，以浮云比喻游子漂泊不定，以落日比喻故人依依不舍的深情。结尾以马的嘶鸣声作结，余音绕梁，将离别的伤感表达得含蓄而深沉。全诗虽然只有八句，却用极少的文字表达了丰富的内容。',
      trivia: '李白一生漫游各地，对送别有深刻体验。他的送别诗往往豪迈中带着深情，与一般送别诗的哀愁不同，展现了他独特的个性。这首诗是李白送别诗中最具意象性的作品。',
      blanks: [1, 5, 9, 13, 17],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"桃花潭水深千尺，不及汪伦送我情"是千古名句，以桃花潭水的深度来比喻友情的深厚，夸张而生动。全诗语言朴素，情感真挚，是李白友情诗中的代表作。诗人用极简洁的语言表达了最深沉的情感。',
      trivia: '汪伦是泾县的一位普通百姓，他写信邀请李白来游玩，信中说此地有"十里桃花"和"万家酒店"，李白欣然前往，到后才知道"十里桃花"是十里外的桃花潭，"万家酒店"是姓万的人开的酒店，被汪伦的机智逗乐了。这个故事已成为佳话，代代相传。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"野火烧不尽，春风吹又生"是千古名句，以野草顽强的生命力比喻坚韧不拔的精神。全诗以草的枯荣比喻人生的离合，将送别之情融入自然景物，含蓄而深沉。诗人用简洁的语言表达了对人生的思考。',
      trivia: '白居易十六岁时写下此诗，参加科举考试。顾况看到这首诗后，由原来的轻视变为赞赏，说："有才如此，居天下亦不难。"此诗因此成为白居易的成名作。"赋得"是唐代科举考试的一种题目形式，要求在给定的题目基础上作诗。',
      blanks: [1, 5, 9, 13, 17],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写在金陵酒肆与友人告别的情景。柳花飘香，吴姬劝酒，金陵的年轻朋友们依依不舍，频频举杯。结尾以"别意与之谁短长"发问，将离别之情与东流水相比，含蓄而有力。全诗虽然篇幅短小，却用生动的场景表达了深沉的情感。',
      trivia: '李白一生漫游，金陵是他最喜爱的城市之一。他曾多次游历金陵，留下了大量诗篇，对金陵的繁华和历史有深厚感情。这首诗是李白金陵诗中最具生活气息的作品。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"春风十里扬州路，卷上珠帘总不如"是千古名句，将扬州路上的所有美女都比下去，对送别对象的赞美达到极致。全诗以豆蔻比喻少女的青春，清新而含蓄。诗人用极简洁的语言表达了对美女的赞美。',
      trivia: '杜牧在扬州任职期间，流连于扬州的繁华之中，留下了大量描写扬州风情的诗篇。"豆蔻年华"一词由此而来，后专指十三四岁的少女。这首诗虽然篇幅短小，但意蕴深长。',
      blanks: [1, 5, 9, 13],
    },
    {
      id: 'zengbie-er',
      ...
      appreciation: '"蜡烛有心还惜别，替人垂泪到天明"是千古名句，以蜡烛的燃烧比喻离别的泪水，含蓄而深情。"多情却似总无情"写出了离别时强作欢颜、内心却悲痛欲绝的矛盾心理。全诗虽然篇幅短小，却用生动的比喻表达了深沉的情感。',
  ...
  poems: [
    {
      ...
      appreciation: '"君向潇湘我向秦"是千古名句，简洁地写出了两人分别后各奔东西的命运。全诗以杨柳、杨花、风笛等意象，营造出浓郁的离别氛围，最后一句言简意赅，余味无穷。诗人用极少的文字表达了丰富的内容。',
      trivia: '郑谷是晚唐诗人，以《鹧鸪》诗著名，被称为"郑鹧鸪"。这首《淮上与友人别》是他最著名的送别诗，语言清新，情感真挚。这首诗虽然篇幅短小，但意蕴深长。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"一片冰心在玉壶"是千古名句，以冰心玉壶比喻自己高洁的品格，表达了对友人的嘱托：请告诉洛阳的亲友，我依然保持着纯洁的心志。全诗情景交融，将离别之情与自我表白融为一体。诗人用极简洁的语言表达了深沉的情感和高洁的品格。',
      trivia: '王昌龄因"不护细行"被贬，但他始终保持高洁的品格。"一片冰心在玉壶"成为后世表达高洁品格的经典意象，被广泛引用。这首诗虽然篇幅短小，但意蕴深长，是唐代送别诗中的佳作。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写别后对友人的思念。杨柳在春风中摇摆，小园里的桃李花朵不开放，仿佛在等待友人归来。全诗以拟人手法，将花木的等待与对友人的思念融为一体，情感真挚而含蓄。诗人用自然意象来表达对友人的思念。',
      trivia: '长孙佐辅是唐代诗人，生平事迹不详，但留下了一些情感真挚的诗篇。杭州自古以来就是著名的风景名胜之地，"上有天堂，下有苏杭"的说法由来已久。这首诗虽然篇幅短小，但意蕴深长。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '此诗写刘禹锡离开苏州时，百姓依依不舍的感人场景。苏州十万户人家仿佛都在哭泣，桃花盛开的春日里，吴娃唱歌，蛮女悲啼，相送之情无限，泪水如散丝般落下。全诗情感真挚，展现了刘禹锡深得民心的一面。诗人用生动的场景表达了对苏州的眷恋。',
      trivia: '刘禹锡曾在苏州任刺史，政绩卓著，深受百姓爱戴。他在苏州期间，大力推广竹枝词等民间文学形式，对唐代文学的发展做出了重要贡献。这首诗虽然篇幅较长，但情感深沉，是唐代送别诗中的佳作。',
      blanks: [2, 6, 11, 16],
    },
  ],
};
  ...
  poems: [
    {
      ...
      appreciation: '"莫愁前路无知己，天下谁人不识君"是千古名句，以豪迈的语气鼓励友人，一扫送别诗的悲凉之气。全诗以北方冬天的苍茫景色为背景，在悲凉中透出豪迈，展现了盛唐诗歌的精神风貌。诗人用极简洁的语言表达了对友人的信心和鼓励。',
      trivia: '董大是著名琴师董庭兰，以弹奏胡笳著称。高适是唐代著名边塞诗人，与岑参并称"高岑"，他的诗以豪迈奔放、慷慨激昂著称。这首诗虽然篇幅短小，但气势磅礴，是唐代送别诗中最具鼓舞力的作品。',
      blanks: [1, 5, 9, 13],
    },
  ],
};
